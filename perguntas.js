const perguntasLocais = [
    ...
    },
    {
        ...
        opcao_B: "a arte contemporânea, tal como a performance de Michelle Mattiuzzi, equipara um tipo de arte engajada e pós-colonialista à arte dita 'da cultura dominante'[cite: 57].",
        opcao_C: "a performance da artista aborda o corpo negro feminino permeado por classificações sociais de identidade baseadas em discursos heteronormativos, padrões de anatomias, forma e cor sobre o corpo[cite: 58].",
        opcao_D: "a arte política e socialmente engajada surgiu a partir da efetiva aplicação da legislação que prevê o ensino da História e das culturas brasileira e africana em todos os níveis de ensino[cite: 59].",
        opcao_E: "o uso do próprio corpo em performance, por mulheres, contradiz as reflexões características do feminismo, que critica o corpo feminino objetificado[cite: 60].",
        resposta_correta: "C"
    },
    {
        id: 6,
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 69]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a ll é uma proposição falsa. [cite: 69]",
        opcao_D: "A asserção I é uma proposição falsa, e a Il é uma proposição verdadeira. [cite: 70]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 71]",
        resposta_correta: "A"
    },
    {
        id: 7,
        ...
        opcao_B: "A arte indígena, como a obra de Denilson Baniwa, compõe o corpo de objetos artísticos brasileiros e somou-se à renovação e à criação estética do Modernismo no Brasil[cite: 80].",
        opcao_C: "A infogravura de Denilson Baniwa problematiza a presença do indígena na arte, mas também a defesa de seus direitos como brasileiros, nas questões territoriais e de defesa da vida[cite: 81].",
        opcao_D: "O artista, ao utilizar em seu desenho códigos visuais semelhantes ao viés ocidentalista de representação naturalista, demonstra a interiorização de sua subalternidade étnica e cultural[cite: 82].",
        opcao_E: "Os critérios universais existentes para determinar de antemão que um objeto singular possa ser considerado como obra de arte, seja indígena ou não indígena, são norteados por um conceito comum de arte[cite: 83].",
        resposta_correta: "C"
    },
    {
        id: 8,
    ...
    },
    {
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 113]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a ll é uma proposição falsa. [cite: 113]",
        opcao_D: "A asserção I é uma proposição falsa, e a Il é uma proposição verdadeira. [cite: 114]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 115]",
        resposta_correta: "B"
    },
    {
        id: 11,
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 126]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a ll é uma proposição falsa. [cite: 126]",
        opcao_D: "A asserção I é uma proposição falsa, e a Il é uma proposição verdadeira. [cite: 127]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 128]",
        resposta_correta: "A"
    },
    {
        id: 12,
    ...
    },
    {
        ...
        opcao_B: "fracassou no aspecto da conscientização sobre o descarte do lixo, conforme demonstram as reportagens[cite: 147].",
        opcao_C: "promoveu a espetacularização do lixo, por expô-lo em um ponto de atração turística sem vínculo com a arte[cite: 148].",
        opcao_D: "aproximou o público, por meio da experiência sensível, dos problemas relacionados com o lixo apontados nas reportagens[cite: 149].",
        opcao_E: "incentivou o uso de materiais recicláveis no Ensino de Artes como forma de contribuição com a natureza e com a padronização de soluções criativas[cite: 150].",
        resposta_correta: "D"
    },
    {
        id: 14,
    ...
    },
    {
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 169]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a Il é uma proposição falsa. [cite: 169]",
        opcao_D: "A asserção I é uma proposição falsa, e a Il é uma proposição verdadeira. [cite: 170]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 171]",
        resposta_correta: "A"
    },
    {
        id: 16,
    ...
    },
    {
        ...
        opcao_B: "NOBLE, T.; WEBSTER, S. Miss understood & Mr. Meanor. 1997. Lixo e itens pessoais, madeira, projetor de luz e sensor de luz[cite: 191].",
        opcao_C: "ANDRADE, F. Composição em Vermelho, 1972-1974. Materiais diversos[cite: 192, 193].",
        opcao_D: "CATUNDA, L. Bicho. 2000. Acrílica sobre tela e espuma[cite: 194].",
        opcao_E: "SCHWANKE, L. H. sem título. Final dos anos 1980. Apropriação de escorredores de arroz sobre suporte de papelão[cite: 196].",
        resposta_correta: "B"
    },
    {
        id: 18,
        ...
        opcao_B: "A obra de Olafur Eliasson apresenta uma solução para a necessidade de acesso à energia, em contextos sociais e climáticos diversos[cite: 207].",
        opcao_C: "A instalação de Olafur Eliasson, inspirada em fenômenos da natureza, desafia as percepções do natural e do artificial[cite: 208].",
        opcao_D: "O artista estimula os espectadores a perceber a natureza dos objetos, lâmpadas, espelho e umidificadores, ao compará-los com os fenômenos da natureza[cite: 209].",
        opcao_E: "A obra de Olafur Eliasson, por meio das percepções das cores, da névoa e do ar, desvia a atenção do espectador das questões socioambientais[cite: 210].",
        resposta_correta: "C"
    },
    {
        id: 19,
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 221]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a Il é uma proposição falsa. [cite: 221]",
        opcao_D: "A asserção I é uma proposição falsa, e a Il é uma proposição verdadeira. [cite: 222]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 223]",
        resposta_correta: "A"
    },
    {
        id: 20,
    ...
    },
    {
        ...
        opcao_A: "As asserções I e II são proposições verdadeiras, e a II é uma justificativa correta da I.",
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 255]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a Il é uma proposição falsa. [cite: 255]",
        opcao_D: "A asserção I é uma proposição falsa, e a Il é uma proposição verdadeira. [cite: 256]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 257]",
        resposta_correta: "B"
    },
    {
        id: 23,
    ...
    },
    {
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 274]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a ll é uma proposição falsa. [cite: 274]",
        opcao_D: "A asserção I é uma proposição falsa, e a Il é uma proposição verdadeira. [cite: 275]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 276]",
        resposta_correta: "A"
    },
    {
        id: 25,
    ...
    },
    {
        ...
        opcao_B: "Na figura 2, o artista organiza visualmente corpos que transitam na hibridez dos múltiplos gêneros[cite: 330].",
        opcao_C: "A figura 2 dialoga com a agenda Queer e a figura 1 se opõe à fluidez da noção de gênero[cite: 331].",
        opcao_D: "A figura 2 evidencia os estereótipos de gênero à medida que avança nos planos da obra[cite: 332].",
        opcao_E: "As figuras 1 e 2 limitam a discussão dos estereótipos de gênero[cite: 333].",
        resposta_correta: "B"
    },
    {
        id: 30,
        ...
        opcao_B: "possibilita a construção do conhecimento a partir do isolamento das linguagens e respectivas áreas de atuação[cite: 339].",
        opcao_C: "integra esta área a outros conteúdos, práticas e linguagens, relacionando-os ao mundo a sua volta e ampliando o campo de atuação de professores e estudantes[cite: 340].",
        opcao_D: "desenvolve a meta discursividade, visando a legitimação dos campos de ensino nessa área de conhecimento[cite: 341].",
        opcao_E: "exige dos professores polivalência em campos de atuação distintos, assim como conhecimento e domínio sobre as mais diversas linguagens a fim de transmití-las[cite: 342].",
        resposta_correta: "C"
    },
    {
        id: 31,
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 350]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 351]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira. [cite: 352]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 353]",
        resposta_correta: "A"
    },
    {
        id: 32,
    ...
    },
    {
        ...
        opcao_B: "O fotógrafo vê o mundo a seu modo, portanto, sua fotografia é uma interpretação impregnada de traços de autoria[cite: 366].",
        opcao_C: "A obra tem vida própria e é autônoma, pois a imagem capturada pelo fotógrafo foge ao controle do desejado e ao domínio da técnica[cite: 367].",
        opcao_D: "A fotografia engana, pois é um jogo de ilusões, um tipo de falso testemunho, que faz o espectador acreditar em inverdades e fantasias[cite: 368].",
        opcao_E: "A capacidade da fotografia em transformar as coisas em algo belo resulta dos meios técnicos nela empregados e de sua faculdade para alimentar falsas experiências estéticas[cite: 369].",
        resposta_correta: "B"
    },
    {
        id: 34,
        ...
        opcao_A: "As asserções I e II são proposições verdadeiras, e a II é uma justificativa correta da I.",
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I.",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 379]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira.",
        opcao_E: "As asserções I e II são proposições falsas.",
        resposta_correta: "C"
    },
    ...
    },
    {
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 462]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 463]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira. [cite: 464]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 465]",
        resposta_correta: "C"
    },
    {
        id: 42,
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 473]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 474]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira. [cite: 475]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 476]",
        resposta_correta: "A"
    },
    {
        id: 43,
        ...
        opcao_B: "A escultura de Durham pode ser considerada obra de arte porque segue critérios de autenticidade[cite: 490].",
        opcao_C: "A escultura de Durham segue padrões da arte clássica uma vez que consiste na representação de um retrato[cite: 491].",
        opcao_D: "A obra de um artista que se considera 'primitivo pós-moderno' não deve ser classificada como arte contemporânea[cite: 492].",
        opcao_E: "As manifestações artísticas da população indígena são exemplos de artefatos considerados obras de arte clássicas[cite: 493].",
        resposta_correta: "A"
    },
    {
        id: 44,
    ...
    },
    {
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, e a II é uma justificativa correta da I. [cite: 509]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 510]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira. [cite: 511]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 512]",
        resposta_correta: "D"
    },
    {
        id: 46,
    ...
    },
    {
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I.",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa.",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira. [cite: 541]",
        opcao_E: "As asserções I e II são proposições falsas.",
        resposta_correta: "D"
    },
    {
        ...
        opcao_B: "uma agressão ao meio ambiente aquático, que se justifica por favorecer o turismo regional[cite: 551].",
        opcao_C: "uma obra de arte sensacionalista que, embora bem intencionada, não deveria fazer parte do Musa[cite: 552].",
        opcao_D: "uma boa ideia para recompor a flora e a fauna marinhas, mas com impactos ambientais irreversíveis[cite: 553].",
        opcao_E: "uma obra de arte engajada e, ao mesmo tempo, uma forma de recomposição da flora e da fauna marinhas[cite: 554].",
        resposta_correta: "E"
    },
    {
        id: 49,
    ...
    },
    {
        ...
        opcao_B: "atendimento educacional especializado, priorizando-se o ensino da língua portuguesa, de modo a garantir a educação bilíngue[cite: 579].",
        opcao_C: "processo avaliativo que priorize o uso da língua portuguesa na modalidade escrita, dada a importância da manutenção do registro da aprendizagem[cite: 580].",
        opcao_D: "ensino da língua brasileira de sinais (Libras) após a aquisição da língua portuguesa na modalidade escrita, em processo análogo ao da alfabetização de aluno ouvinte[cite: 581].",
        opcao_E: "educação inclusiva, apesar de a surdez não se enquadrar no campo da deficiência física ou das limitações de mobilidade[cite: 582].",
        resposta_correta: "A"
    },
    {
        id: 52,
        ...
        opcao_B: "realize atividades em seu cotidiano que definam para as crianças o que é masculino e o que é feminino[cite: 589].",
        opcao_C: "se valha das diferenças sexuais naturais entre meninos e meninas para conduzir a classe e manter a disciplina[cite: 590].",
        opcao_D: "se refira à questão de gênero de forma tangencial, suficiente para promover vivência menos intransigente e mais equânime entre homens e mulheres[cite: 591].",
        opcao_E: "reforce modelos de comportamentos socialmente atribuídos a homens e mulheres que formam um conjunto de representações sobre masculinidade e feminilidade[cite: 592].",
        resposta_correta: "A"
    },
    {
        id: 53,
    ...
    },
    {
        ...
        opcao_B: "Utilizar livro didático e figuras previamente selecionadas para sintetizar conceitos e informações relacionados ao conteúdo trabalhado[cite: 607].",
        opcao_C: "Aplicar exercícios de fixação em níveis crescentes de complexidade para a internalização dos conteúdos pelos estudantes[cite: 608].",
        opcao_D: "Partir do saber do cotidiano do estudante sobre a relação entre força e movimento para provocar o surgimento de hipóteses, criar conflitos cognitivos para desenvolvimento do conceito desejado[cite: 609].",
        opcao_E: "Realizar leituras informativas sobre o conteúdo e, a partir da apresentação de slides ilustrativos, descrever o conceito de força e de movimento, apresentando exemplos[cite: 610].",
        resposta_correta: "D"
    },
    {
        id: 55,
        ...
        opcao_B: "as Artes, assim como a História e Literatura, são campos de conhecimento que dialogam diretamente com as questões identitárias e culturais dos sujeitos[cite: 616, 617]. Ao aplicar a nova legislação, os estabelecimentos de ensino promovem um processo de educação das relações étnicorraciais de matrizes africanas e indígenas no país[cite: 618].",
        opcao_C: "o ensino da Arte facilitará a afirmação das identidades étnicas através do estudo da auto- imagem do povo brasileiro[cite: 619]. Ao aplicar a referida lei, promoverá a ampliação do acesso de negros ao ensino superior, que será alterado pelo ensino da contribuição dos africanos e indígenas[cite: 620].",
        opcao_D: "os arte-educadores são obrigados a conhecer e ensinar a História da África nas escolas[cite: 621]. Ao utilizar as artes visuais na educação para as relações étnicorraciais, facilitarão a compreensão e contextualização da temática da nova disciplina imposta pelas citadas leis federais[cite: 622].",
        opcao_E: "a aplicabilidade da referida legislação nas escolas exigirá o uso da música de origem negra em todas as aulas de Artes[cite: 623]. Ao trabalhar a musicalidade de influência africana, os arte-educadores promoverão a difusão da contribuição dos negros e indígenas e o diálogo com a música de qualidade na cultura nacional[cite: 624].",
        resposta_correta: "B"
    },
    {
        id: 56,
        ...
        opcao_B: "Considera-se cada produto artístico como um relato acabado e fechado, por conseguinte, as interpretações também são sempre limitadas e impostas pelo conhecimento disciplinar[cite: 632].",
        opcao_C: "Defende-se uma concepção de arte como algo pertencente a uma cultura de nível superior, à qual só chega, quer como produtores, quer como apreciadores, indivíduos muito preparados esteticamente a partir do domínio de saberes disciplinares[cite: 633].",
        opcao_D: "Um modo de motivação dos estudantes parte da adoção de uma postura pedagógica em artes visuais que não concebe a arte como mero artefato para apreciação, mas sim como 'experiência' capaz de conectar-se com a própria cultura estética dos estudantes[cite: 634].",
        opcao_E: "As propostas pedagógicas culturalistas desconsideram o 'popular' e o 'cotidiano' que, na maioria das vezes, pulsa fora dos ambientes culturais tradicionais, confrontando-se com as experiências vitais dos estudantes e favorecendo uma visão historicista do fazer artístico[cite: 635].",
        resposta_correta: "D"
    },
    {
        id: 57,
    ...
    },
    {
        ...
        opcao_B: "Na educação brasileira, as manifestações de arte popular são valorizadas e assumem na escola um papel importante nas práticas escolares correntes[cite: 695].",
        opcao_C: "O ensino da arte no Brasil, desde seus primórdios, ultrapassa as fronteiras entre as chamadas 'artes maiores' e aquelas que emanam da cultura popular[cite: 696].",
        opcao_D: "Um dos problemas da educação brasileira no que diz respeito ao ensino de artes reside na preferência pela arte erudita, que não apenas se revela nos programas curriculares como, também, nas próprias concepções de arte dos arte-educadores[cite: 697].",
        opcao_E: "Os arte-educadores brasileiros têm uma concepção de arte intercultural, pelo que recorrem, em sua prática de sala de aula, às manifestações artísticas populares[cite: 698].",
        resposta_correta: "D"
    },
    {
        id: 63,
    ...
    },
    {
        ...
        opcao_A: "As asserções I e II são proposições verdadeiras, e a II é uma justificativa correta da I.",
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I.",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 718]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira.",
        opcao_E: "As asserções I e II são proposições falsas.",
        resposta_correta: "C"
    },
    ...
    },
    {
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 759]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 759]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira. [cite: 760]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 761]",
        resposta_correta: "A"
    },
    {
        id: 68,
    ...
    },
    {
        ...
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 800]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira.",
        opcao_E: "As asserções I e II são proposições falsas.",
        resposta_correta: "C"
    },
    ...
    },
    {
        ...
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 824]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 824]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira. [cite: 825]",
        opcao_E: "As asserções I e II são proposições falsas. [cite: 826]",
        resposta_correta: "A"
    },
    {
        id: 73,
    ...
    },
    {
        ...
        opcao_A: "As asserções I e II são proposições verdadeiras, e a II é uma justificativa correta da I.",
        opcao_B: "As asserções I e II são proposições verdadeiras, mas a II não é uma justificativa correta da I. [cite: 844]",
        opcao_C: "A asserção I é uma proposição verdadeira, e a II é uma proposição falsa. [cite: 844]",
        opcao_D: "A asserção I é uma proposição falsa, e a II é uma proposição verdadeira.",
        opcao_E: "As asserções I e II são proposições falsas.",
        resposta_correta: "B"
    },
    ...
    },
    {
        ...
        opcao_C: "estabelece que a melhoria da educação básica evidencia a base para o desenvolvimento, pois o crescimento econômico é o indicador do percentual de recursos do PIB a ser aplicado em educação[cite: 898].",
        opcao_D: "disponibiliza para os gestores escolares o crescimento de 10% dos investimentos do PIB em educação, ao ano, durante os próximos 10 anos e um Sistema Nacional de Avaliação para verificar a efetivação das diretrizes e metas dispostas no referido Plano[cite: 899].",
